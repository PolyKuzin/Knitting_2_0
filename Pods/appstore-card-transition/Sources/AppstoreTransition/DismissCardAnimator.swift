...
//                self.params.fromCell.isHidden = false
        ...
        self.params.fromCell.isHidden = false
        self.params.fromCell.alpha = 0
        UIView.animate(withDuration: transitionDuration(using: ctx), delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 0.0, options: [], animations: {
            cardDetailView.alpha = 0
            self.params.fromCell.alpha = 1
